/**
 * GET /api/action-center-drawer?code=BATCH-CODE
 *
...
import { getDrawerData } from "@/lib/action-center-data";
...
export async function GET(req: NextRequest) {
  // Action Center is an Ops surface — gate this drawer endpoint to match.
